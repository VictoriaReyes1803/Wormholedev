...
import { ArrowRight, ChevronDown, Code2, Smartphone, Brain } from 'lucide-react'
import { useTranslation } from 'react-i18next'
import { fadeUp, floatAnim, chipAnim } from '../lib/animations.js'

const floatingCards = [
  { icon: Code2, label: 'Web', sub: 'Full-stack', color: 'from-blue-500 to-blue-600', delay: 0, pos: 'top-12 right-0 lg:right-8' },
  { icon: Smartphone, label: 'Mobile', sub: 'iOS & Android', color: 'from-cyan-500 to-cyan-600', delay: 0.15, pos: 'top-36 right-4 lg:right-24' },
  { icon: Brain, label: 'AI', sub: 'Smart tools', color: 'from-violet-500 to-violet-600', delay: 0.3, pos: 'top-60 right-0 lg:right-4' },
]
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-white dark:bg-gray-950 pt-16">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="animate-mesh-1 absolute -top-40 -right-40 w-[700px] h-[700px] rounded-full bg-blue-100/60 dark:bg-blue-900/10 blur-3xl" />
        <div className="animate-mesh-2 absolute top-1/2 -left-40 w-[500px] h-[500px] rounded-full bg-cyan-100/50 dark:bg-cyan-900/10 blur-3xl" />
        <div className="animate-mesh-3 absolute bottom-0 right-1/4 w-[400px] h-[400px] rounded-full bg-violet-100/30 dark:bg-violet-900/10 blur-3xl" />
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-20 lg:py-24">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="max-w-xl">
            ...
            <motion.h1 {...fadeUp(0.2)} className="text-5xl sm:text-6xl lg:text-6xl xl:text-7xl font-900 leading-[1.05] tracking-tight text-gray-900 dark:text-white mb-8">
              {t('hero.headline1')}{' '}
              ...
              {chips.map((chip, i) => {
                ...
                return (
                  <motion.span
                    key={chip.label}
                    {...chipAnim(i)}
                    className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full bg-blue-50 dark:bg-blue-950/50 border border-blue-200 dark:border-blue-800/60 text-blue-700 dark:text-blue-400 text-sm font-600 cursor-default select-none"
                  >
                    <Icon size={13} />
                    {chip.label}
                  </motion.span>
            ...
            <motion.div {...fadeUp(0.55)} className="flex flex-col sm:flex-row gap-3">
              <button
            ...
            <motion.div {...fadeUp(0.65)} className="mt-12 flex flex-wrap gap-8">
              {[
            ...
            >
              <div className="relative">
                ...
                <motion.div
                  ...
                  className="relative w-64 h-64 rounded-3xl border border-blue-200 dark:border-blue-800/60 bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-950/30 dark:to-cyan-950/30 flex items-center justify-center shadow-2xl"
                >
